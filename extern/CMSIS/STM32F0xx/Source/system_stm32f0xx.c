...
/** @addtogroup STM32F0xx_System_Private_Defines
  * @{
  */
// PLD Clock source selectable via #define, one of
// PLL_SOURCE_HSI        // HSI (~8MHz) used to clock the PLL, and the PLL is used as system clock source
...
#elif defined (PLL_SOURCE_HSE) /* Enable HSE */    
...
#else
#error "Please define either PLL_SOURCE_HSE or PLL_SOURCE_HSI"
#endif
}
